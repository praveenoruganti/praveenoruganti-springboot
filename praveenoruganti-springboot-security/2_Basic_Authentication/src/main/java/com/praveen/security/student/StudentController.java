...
public class StudentController {
	...
	private static final List<Student> STUDENTS = Arrays.asList(
			Student.builder().Id(1).name("Praveen Oruganti").build(),
			Student.builder().Id(2).name("Kiran Kumar Badugu").build(),
			Student.builder().Id(3).name("Praneeth Vishnubhotla").build());
