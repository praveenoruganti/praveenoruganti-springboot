...
praveenorugantitech-rabbitmq-integration-service:         
          rabbitmq:
            queueName: praveenmq
...
public class MessageProducer {
	...
	@Value("${praveenorugantitech-rabbitmq-integration-service.rabbitmq.queueName}")
	private String queueName;

	@Value("${praveenorugantitech-rabbitmq-integration-service.rabbitmq.topicExchange}")
